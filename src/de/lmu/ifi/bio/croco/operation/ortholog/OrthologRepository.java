...
/**
 * Retrieves and buffers orthologs using the {@link de.lmu.ifi.bio.croco.connector.QueryService}.
 * @author pesch
 *
 */
...
public class OrthologRepository {
	...
	/**
	 * Creates/Returns a unique {@link de.lmu.ifi.bio.croco.operation.ortholog.OrthologRepository} instance given the query service
	 * @param service
	 * @return
	 */
