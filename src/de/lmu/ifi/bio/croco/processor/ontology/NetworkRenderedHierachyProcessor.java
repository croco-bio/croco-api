...
import de.lmu.ifi.bio.croco.processor.ontology.NetworkOntologyWriter.CroCoRepositoryProcessor;
...
public class NetworkRenderedHierachyProcessor implements CroCoRepositoryProcessor {
	...
	public void process(Integer rootId, Integer networkId, File networkFile,File infoFile,File annotationFile) throws Exception {
		...
		Network network = Network.getNetworkReader().setNetworkInfo(infoFile).setEdgeRepositoryStrategy(EdgeRepositoryStrategy.LOCAL).setNetworkFile(networkFile).readNetwork();
	...
	public static void main(String[] args) throws Exception {
		...
		NetworkOntologyWriter hierachy = new NetworkOntologyWriter();
